...
import PlaygroundDemo from "../../_playground/PlaygroundDemo";

// Landing screen. The hero pairs the pitch with the live wallet demo: a nested
// <Router> running flemo natively inside the shell (shared-axis tabs, cupertino
// push, a <Layer> sheet). The features grid and transition gallery arrive in
// follow-up PRs. The screen scrolls inside the <Slot> while the header stays
// pinned, and the shared-axis slide carries this whole region to Showcase.
function HomeScreen() {
    ...
    <Screen hideStatusBar hideSystemNavigationBar backgroundColor="var(--color-bg)">
      <div className="h-full overflow-y-auto">
        <div className="mx-auto grid max-w-[1240px] items-center gap-12 px-6 py-20 lg:grid-cols-[1.1fr_0.9fr] lg:py-28">
          ...
          {/* The live interactive flemo demo: a nested <Router> wallet app. */}
