...
| 옵션             | 동작                                                                                                                                   |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| `transitionName` | 이번 내비게이션의 전환을 지정. `pop`에서는 뒤로가기 애니메이션을 지정 — 여러 화면을 접을 때 맨 위 화면의 전환이 원하는 게 아닐 때 유용 |
