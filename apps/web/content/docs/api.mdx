...
| `RouterScopeProvider` | Hosts the Router's request-scoped stores so code outside it can read them. | `@flemo/react`        | [Router](./router#reading-router-state-from-outside-the-router) |
...
| `useStores()`                                                                    | All four request-scoped store APIs (imperative)             | [Router](./router#reading-router-state-from-outside-the-router) |
| `useHistoryStore` · `useNavigateStore` · `useTransitionStore` · `useScreenStore` | Selector reads of the active Router's stores                | [Router](./router#reading-router-state-from-outside-the-router) |
