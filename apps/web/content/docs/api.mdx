...
| `useHistoryStore` · `useNavigateStore` · `useScreenStore` | Lower-level selector reads of the active Router's stores    | [Router](./router#reading-router-state-from-outside-the-router) |
