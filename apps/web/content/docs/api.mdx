...
| `LayoutScreen` | Screen variant for shared `layoutId` morphs across screens.        | `@flemo/layout` | [Screen](./screen#layoutscreen) |
| `LayoutConfig` | Wraps motion children with the current screen's transition timing. | `@flemo/layout` | —                               |
