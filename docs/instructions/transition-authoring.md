...
These rules describe runtime behavior. Violations can pass types, produce correct DOM, and leave the console silent while producing wrong motion. Referenced source comments explain each rule.
