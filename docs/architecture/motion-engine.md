...
| `createSwipeController.ts`  | Framework-neutral swipe-back gesture: 8px intent slop + 3:1 axis arbitration before touch ownership, drag-follow inline writes, cancellation-safe release settle via settleScrub, bar mirroring, 6px release tap-slop, layer promotion sharing.                                                                                                |
